...
function generateFakePartData () {
  ...
  for (let i = 0; i < totalRecords; ++i) {
    const stub = { partNumber: faker.lorem.slug(), modelNumber: faker.lorem.slug(), name: faker.lorem.sentence(), description: faker.lorem.paragraph() }
    data.push(stub)
  }
  return (data)
}
